...
package com.mycompany.ProjectManagementSystem.controller;
 ...
 * @author YARUS
 */
@WebServlet(name = "TestServlet", loadOnStartup = 1, urlPatterns = {"/controller", "/index", "/"})
